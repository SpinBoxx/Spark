 ...
 */
final class Version20201021145349 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE favorite (id INT AUTO_INCREMENT NOT NULL, product_id_id INT NOT NULL, user_id_id INT NOT NULL, INDEX IDX_68C58ED9DE18E50B (product_id_id), INDEX IDX_68C58ED99D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, state_id_id INT NOT NULL, gender_id_id INT DEFAULT NULL, size_id_id INT NOT NULL, type_id_id INT NOT NULL, color_primary_id_id INT NOT NULL, color_secondary_id_id INT DEFAULT NULL, brand_id_id INT NOT NULL, quality_id_id INT NOT NULL, category_id_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, picture_product VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, link LONGTEXT DEFAULT NULL, creation_datetime DATETIME NOT NULL, update_datetime DATETIME DEFAULT NULL, INDEX IDX_D34A04AD9D86650F (user_id_id), INDEX IDX_D34A04ADDD71A5B (state_id_id), INDEX IDX_D34A04AD6F7F214C (gender_id_id), INDEX IDX_D34A04ADAE945C60 (size_id_id), INDEX IDX_D34A04AD714819A0 (type_id_id), INDEX IDX_D34A04AD6853797E (color_primary_id_id), INDEX IDX_D34A04ADD24FF022 (color_secondary_id_id), INDEX IDX_D34A04AD24BD5740 (brand_id_id), INDEX IDX_D34A04AD6BEA5664 (quality_id_id), INDEX IDX_D34A04AD9777D11E (category_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE favorite ADD CONSTRAINT FK_68C58ED9DE18E50B FOREIGN KEY (product_id_id) REFERENCES product (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE favorite DROP FOREIGN KEY FK_68C58ED9DE18E50B');
